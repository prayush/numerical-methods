...
\begin{enumerate}
    ...
    \item \textit{Discussion:} Why is this method (often called Romberg Integration when repeated) computationally cheaper than simply running the Trapezoidal rule with $N=10^6$ points?
\end{enumerate}
